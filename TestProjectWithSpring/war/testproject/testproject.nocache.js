...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "testproject" because\n';
  ...
  $wnd.__gwt_activeModules['testproject'] = {
 ...
 * "/testproject.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['testproject'].superdevmode = true;

  var expectedSuffix = '/testproject.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + testproject + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:testproject';
  var devModeSessionKey = '__gwtDevModeSession:testproject';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/testproject/testproject.nocache.js';
  ...
  $wnd.__gwt_activeModules['testproject'].canRedirect = true;
  $wnd.__gwt_activeModules['testproject'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/testproject?user.agent=' + ua + '&_callback=' + callback;
