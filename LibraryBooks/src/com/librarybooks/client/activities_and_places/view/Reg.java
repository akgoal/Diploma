...
public class Reg extends Composite {
    ...
    private OnRegEvent onRegEvent;

    public Reg(final OnRegEvent onRegEvent) {
        this.onRegEvent = onRegEvent;
        vPanel.add(title);
        ...
        button.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                if (b) {
                    ...
                    userDto.setUsername(login.getText());
                    userDto.setPassword(password.getText());
                    userDto.setEmail(email.getText());
                    userDto.setFirstName(name.getText());
                    userDto.setSecondName(surname.getText());
                    userDto.setMiddleName(patronymic.getText());

                    onRegEvent.onReg(userDto);
//                    Window.alert("Данные верны");
    ...
    public interface OnRegEvent {

        void onReg(UserDto userDto);
    }
}
